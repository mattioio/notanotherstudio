...
export default function HomeContactSection() {
  ...
  return (
    <section
      id="contact"
      className="px-6 md:px-12 py-24 lg:py-32 bg-[#0d0d0d] text-white grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center"
    >
      {/* Left — copy */}
      <div>
        <h2
        ...
        >
          Ready to{" "}
          <span className="text-[#f0c93a]">look like the agency you are?</span>
        </h2>
        <p className="text-white/50 text-base font-light leading-[1.7] fade-up fade-up-delay-1">
          Most agencies are losing instructions to competitors with better-looking brands and websites, and they don&apos;t even know it. Whether you&apos;re starting from scratch or ready for a refresh, let&apos;s fix that. Drop us a message and we&apos;ll come back within one working day.
        </p>
      </div>
